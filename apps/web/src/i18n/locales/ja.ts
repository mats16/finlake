...
export const ja: Dictionary = {
  ...
  sqlWarehouse: {
    label: 'SQL Warehouse',
    loading: 'Warehouse を読み込み中',
    noneAvailable: '起動中の Serverless Warehouse がありません',
    defaultBadge: 'デフォルト',
    running: '起動中',
    stopped: '停止中',
    starting: '起動処理中',
    serverless: 'Serverless',
    serverlessSection: 'サーバーレスウェアハウス',
    proSection: 'Pro ウェアハウス',
    classicSection: 'Classic ウェアハウス',
    otherSection: 'その他のウェアハウス',
  },
  workspaceMapping: {
  ...
  pricing: {
    ...
    delete: '削除',
    deleting: '削除中',
    deleteFailed: '価格表テーブルの削除に失敗しました',
    deleteConfirmTitle: '価格表テーブルを削除しますか？',
    deleteConfirmDescription:
      'pricing_data から「{name}」を削除し、Unity Catalog テーブル「{table}」を DROP します。',
    confirmDeleteAction: 'テーブルを削除',
    runFailed: '価格データの実行に失敗しました',
    columns: {
      name: 'Name',
      table: 'Table',
      status: 'Status',
  ...
  explore: {
    ...
    costExplore: {
      ...
      loadFailed: 'Cost Explore データを読み込めませんでした。',
      ungrouped: 'Ungrouped',
      groupBy: 'Group By',
      ...
      empty: {
        noData: 'コストデータがありません',
        noRows: '集計行がありません',
        adjustFilters: '期間、Group By、またはフィルタを変更してください。',
      },
    },
    genie: {
      title: 'Genie',
  ...
  settings: {
    ...
    provisionVolumeFailed:
      'ボリューム「{volume}」を作成できませんでした。下の警告を確認してください。',
    ...
    provisionScopeUsersDownloadsVolume: '{group} の downloads volume アクセス',
    ...
    medallion: {
      schemaLabel: 'スキーマ名',
      goldLabel: 'Gold',
      goldHelp: '集計済みのコストファクトや分析用テーブルを配置するスキーマです。',
      silverLabel: 'Silver',
      silverHelp: 'FOCUS 形式へ正規化した中間データを配置するスキーマです。',
      bronzeLabel: 'Bronze',
      bronzeHelp: '外部ソースから取り込んだ生データと downloads volume を配置するスキーマです。',
      pricingLabel: 'Pricing',
      pricingHelp: '価格データ用スキーマです。値は pricing 固定で変更できません。',
      invalid:
