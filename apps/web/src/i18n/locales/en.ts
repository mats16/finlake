export const en = {
  ...
  sqlWarehouse: {
    ...
    noneAvailable: 'No running serverless warehouse',
    defaultBadge: 'Default',
    running: 'Running',
    stopped: 'Stopped',
    starting: 'Starting',
    serverless: 'Serverless',
    serverlessSection: 'Serverless warehouses',
    proSection: 'Pro warehouses',
    classicSection: 'Classic warehouses',
    otherSection: 'Other warehouses',
  },
  workspaceMapping: {
  ...
  workspaces: {
    ...
    desc: 'Review and correct Databricks workspace_id to domain mappings.',
    refresh: 'Refresh',
    loadFailed: 'Failed to load workspace mappings',
    addTitle: 'Add workspace mapping',
    updateTitle: 'Update workspace mapping',
    modalDesc: 'Paste a Databricks workspace domain or URL. FinLake stores only the domain.',
    ...
    edit: 'Edit',
    delete: 'Delete',
    deleteConfirm: 'Delete workspace mapping for {id}?',
    emptyDesc: 'No workspace mappings configured.',
    invalidWorkspaceId: 'Workspace ID must be numeric and at most 32 digits.',
  ...
  pricing: {
    ...
    delete: 'Delete',
    deleting: 'Deleting',
    deleteFailed: 'Pricing table deletion failed',
    deleteConfirmTitle: 'Delete pricing table?',
    deleteConfirmDescription:
      'This deletes "{name}" from pricing_data and drops Unity Catalog table "{table}".',
    confirmDeleteAction: 'Delete table',
    runFailed: 'Pricing data run failed',
    columns: {
      name: 'Name',
      table: 'Table',
      status: 'Status',
  ...
  explore: {
    ...
    costExplore: {
      ...
      loadFailed: 'Failed to load cost explore data.',
      ungrouped: 'Ungrouped',
      groupBy: 'Group By',
      ...
      filters: {
        ...
        include: 'Include',
        exclude: 'Exclude',
        noValues: 'No values in this period.',
        provider: 'Platform',
      ...
      metrics: {
        accruedCosts: 'Accrued Costs',
        previousCosts: 'Previous Period Costs',
        series: 'Visible Series',
      },
      columns: {
        currentCost: 'Accrued Costs',
        previousCost: 'Previous Period Costs',
        change: 'Change',
        actions: 'Actions',
      },
      tableView: {
      ...
      changeDisplay: {
        percent: 'Show change as percent',
        currency: 'Show change as currency',
      },
      chartType: {
        line: 'Show line chart',
        stackedBar: 'Show stacked bar chart',
      },
      rows: {
      ...
      empty: {
        noData: 'No cost data',
        noRows: 'No grouped rows',
        adjustFilters: 'Adjust the date range, group by, or filters.',
      },
    },
    genie: {
      title: 'Genie',
  ...
  settings: {
    ...
    provisionVolumeFailed: 'Could not create volume "{volume}" — see warnings below.',
    ...
    provisionScopeUsersDownloadsVolume: '{group} downloads volume access',
    ...
    medallion: {
      ...
      goldLabel: 'Gold',
      goldHelp: 'Stores aggregated cost facts and analytics tables.',
      silverLabel: 'Silver',
      silverHelp: 'Stores normalized intermediate data in FOCUS format.',
      bronzeLabel: 'Bronze',
      bronzeHelp: 'Stores raw data ingested from external sources and the downloads volume.',
      pricingLabel: 'Pricing',
      pricingHelp: 'Schema for pricing data. This value is fixed to pricing and cannot be edited.',
      invalid:
  ...
  governedTags: {
    title: 'Governed Tags',
    desc: 'Manage cost attribution tags consistently across platforms.',
    refresh: 'Refresh',
    syncDatabricks: 'Sync Databricks',
    syncDatabricksTag: 'Sync {tag} to Databricks',
    enableDatabricksTag: 'Create Databricks governed tag {tag}',
    disableDatabricksTag: 'Delete Databricks governed tag {tag}',
    syncTag: 'Sync',
    ...
    columns: {
      ...
      databricks: 'Databricks',
      databricksDetail: 'Governed tags',
      aws: 'Amazon Web Services',
      awsDetail: 'Cost allocation tags',
    },
    status: {
      governed: 'Governed',
      missing: 'Missing',
